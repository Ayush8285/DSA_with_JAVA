...
public class BottomUp {
    ...
    public static void main(String[] args) {
        String s1 = "sunday";
        String s2 = "saturday";
        System.out.println("Minimum operations required to convert " + s1 + " to " + s2 + " is: " + findMinOperationsBU(s1, s2));
    }
    
    
    public static int findMinOperationsBU(String s1, String s2) {
